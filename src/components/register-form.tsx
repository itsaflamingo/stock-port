    ...
    return (
        <form className="flex flex-col gap-2 w-5/7">
            ...
            <div className="flex justify-between p-2">
                ...
                <button className="rounded-[3px] font-['Open_Sans',sans-serif] text-[14px] leading-[21px] text-white font-extrabold text-center uppercase px-[14px] bg-blue-500 w-2/4" onClick={(e) => console.log('register')}>Register</button>
            </div>
        </form>
    )
}